    ...
    >
      ...
      <div style={{ display: 'flex', borderBottom: '1px solid var(--border)', background: 'var(--bg-tertiary)', flexShrink: 0 }}>
        <button
          ...
          style={{ flex: 1, padding: '10px 0', fontSize: '13px', fontWeight: activeTab === 'sessions' ? 600 : 400, background: 'none', border: 'none', cursor: 'pointer', borderBottom: activeTab === 'sessions' ? '2px solid var(--accent-blue)' : '2px solid transparent', color: activeTab === 'sessions' ? 'var(--text-primary)' : 'var(--text-muted)' }}
        >
          Chats
        </button>
        <button
          onClick={() => setActiveTab('explorer')}
          style={{ flex: 1, padding: '10px 0', fontSize: '13px', fontWeight: activeTab === 'explorer' ? 600 : 400, background: 'none', border: 'none', cursor: 'pointer', borderBottom: activeTab === 'explorer' ? '2px solid var(--accent-blue)' : '2px solid transparent', color: activeTab === 'explorer' ? 'var(--text-primary)' : 'var(--text-muted)' }}
        >
          Explorer
        </button>
      </div>
